...
from core.Models.UWModels import LSTMUnet
@NETWORK.register_module()
class CLIP_UIE(BaseNet):
    def __init__(self,
                 backbone=None,
                 pretrained=None,
                 init_weight_type=None,
                 get_parameter=True):
        super(CLIP_UIE, self).__init__(backbone, pretrained, init_weight_type, get_parameter)
    ...
    def _init_layers(self):
        ...
        self.unet = LSTMUnet.UNet_emb_oneBranch_symmetry_noreflect()
        # rgb
...
#degradation_x
        ...
        # confindence_deg = confindence_out[:, 6:9, :, :]
        output = confindence_rgb * rgb_out + \
                              confindence_hsv * hsv_out_rgb
        return output
               #, rgb_out, hsv_out_rgb
